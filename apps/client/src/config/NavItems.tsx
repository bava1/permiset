...
export const NAV_ITEMS = [
  ...
  { label: "ChatAI", path: "/chat", icon: <TipsAndUpdatesIcon />, roles: ["User", "Manager", "Administrator"] },
  ...
  { label: "Docs", path: "/docs", icon: <ArticleIcon />, roles: ["Manager", "Administrator"] },
  { label: "Analytics", path: "/analytics", icon: <InsightsIcon />, roles: ["Manager","Administrator"] },
